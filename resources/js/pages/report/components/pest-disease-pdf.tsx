...
export default function PestDiseasePDF({ reportDate, data }: PestDiseasePDFProps) {
    const titleDate = format(reportDate, 'MMMM dd, yyyy');

    // Render a table row
    const renderTableRow = (index: number, employee?: PestDiseaseEmployee) => {
    ...
    // Render a table
    const renderTable = (employees: PestDiseaseEmployee[], maxRows: number) => {
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerCenter}>
                        ...
                        <Text style={styles.department}>DEPARTMENT: PEST & DISEASE</Text>
                    </View>
                    <View style={styles.headerRight} />
                </View>

                {/* Regular Employees Table (First Section - unlabeled) */}
                <View style={styles.tableContainer}>{renderTable(data.regular || [], 6)}</View>

                {/* PROBITIONARY Section */}
                <Text style={styles.sectionTitle}>PROBITIONARY</Text>
                <View style={styles.tableContainer}>{renderTable(data.probationary || [], 7)}</View>

                {/* SURVEYOR Section */}
                <Text style={styles.sectionTitle}>SURVEYOR</Text>
                <View style={styles.tableContainer}>{renderTable(data.surveyor || [], 3)}</View>

                {/* PDC CONTRACTUAL Section */}
                <Text style={styles.sectionTitle}>PDC CONTRACTUAL</Text>
                <View style={styles.tableContainer}>{renderTable(data.pdcContractual || [], 7)}</View>

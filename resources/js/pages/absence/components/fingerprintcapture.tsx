...
import { Fingerprint, Camera, Check } from 'lucide-react';
...
const FingerprintCapture: React.FC<FingerprintCaptureProps> = ({ onCapture, captured }) => {
  ...
  return (
      <div className="space-y-4">
          <div
              className="flex items-center justify-center rounded-lg border-2 border-dashed border-green-300 bg-green-50 p-8 cursor-pointer"

...
class AbsenceCredit extends Model
{
  use HasFactory;
  ...
  /**
   * Get or create absence credits for an employee for a specific year
   */
  ...
  /**
   * Update used credits when an absence is approved
   */
  ...
  /**
   * Refund credits when an absence is cancelled or rejected
   */
